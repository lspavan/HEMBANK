		...
		<table cellpadding="0" cellspacing="0" id="content1">
			<tr align="justify">
				<td class="con" valign="top">
					...
					<p>This is Global Business bank which is under business and
						finance.</p>
					<p>We used results to drive growth in all our major income
						lines while significantly improving our operational efficiencies,
						evidenced in the moderation of our cost to income ratio at 31
						percent.</p>
				</td>
				...
				<td class="con" valign="top">
					...
					<p>These Global Business bank would be idle for building a
						successful online businesses for secure transactions.</p>
					<p>Earnings growth for the financial sector is quite positive
						and has been revised higher in the past several quarters.</p>
				</td>
				...
				<td class="con" valign="top">
					...
					<p>There are various categories like Online Services, Online
						Payments, Finance...</p>
			...
			<tr align="justify">
				<td width="299" valign="top">
					<div id="welcome" style="border-right: #666666 1px dotted;">
						...
						<br>
						<p>Whenever you have excess funds, the first thing you should think of is a HEM Bank Regular Fixed Deposit.</p>
						<br>
						<!-- <p> Our banking products are simple and less complicated, and designed to keep your hard-earned money in your pocket. -->
						<p> This deposit doesn’t just give you stable returns, financial safety and liquidity, but also the choice of when you want the interest on your principal – monthly or quarterly, depending upon your needs..</p>
...
<%-- 
				...
				<td width="299" valign="top">
					<div id="welcome" style="border-right: #666666 1px dotted;">
						...
						<br>
						<center>
							<a href=stockexchange.jsp><img src="images/stockexchange.jpg" alt="business" width="196"
								height="106"></a>
						</center>
						<br>
						<p>At HEM Bank we offer facility to invest directly in stock market.</p>
						<br>
						<!-- <p> Our banking products are simple and less complicated, and designed to keep your hard-earned money in your pocket. -->
						<p>The Stock Exchange is operating under the name Nasdaq Stockholm, is a stock exchange located in Frihamnen, Stockholm, Sweden.[2][3][4] Founded in 1863,[5] it has become the primary securities exchange of the Nordic countries. More than 300 companies have been listed for trading.</p>
			...
			<%}else{ %>
				<td width="299" valign="top">
					<div id="welcome" style="border-right: #666666 1px dotted;">
						...
						<p>And we make it easy for you to keep on top of your online
							...
							staff to guide you – we are confident there is no goal too high
				...
				<td width="299" valign="top">
					<div id="news">
						...
						<div>
						<h2>Sep. 12, 2017.</h2>
						<p>The Bonds under this Scheme may be held by a person resident in Sweden, being an individual, in his capacity as such individual, or on behalf of minor child, or jointly with any other individual.
						The Bonds shall be denominated in units of one gram of gold and multiples thereof. Minimum investment in the Bonds shall be one gram with a maximum limit of subscription of 4 kg for individuals</p>
